<%-- 
    Document   : cart
    Created on : Apr 21, 2024, 9:30:03 PM
    Author     : admin
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="shoping__checkout">
                                ...
                                <button type="submit" onclick="displaySuccessMessage()" class="primary-btn cart-btn" style="background-color: rgba(1,45,90,255); color: white;" value="CHECKOUT">CHECKOUT</button>
                            </div>
                        </div>
                    </div>
                </form>
